...
euka2plot <-left_join(euka2plot, meta_tot[,c("code_spygen", "site", "habitat")])
...
euka_plot <- ggplot(euka2plot, aes(x=A1, y=A2))+
  ...
  ggtitle("PCoA eukaryote taxa composition")

euka_plot

ggsave("03_Analyses_eukaryotes/03_Outputs/PCoA_euka_tous_sites.png", width = 11, height = 8)
