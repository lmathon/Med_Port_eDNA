...
## Load data
data <- read.csv("03_Analyses_eukaryotes/00_data/eukaryote_presence.csv")
...
ggplot() +
  ...
  #         st.dist = 0.05) +
  labs(title = "Eukaryote taxa richness") +
...
### Save the map
image_write(final, "03_Analyses_eukaryotes/03_Outputs/Map_Richesse.png", density=300)
