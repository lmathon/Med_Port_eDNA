...
## Multivariate dispersion : tester l'homog̩n̩it̩ des variances entre les habitats
...
ggsave("04_Analyses_prokaryotes/03_Outputs/PCoA_horsport_port.png", width = 11, height = 8)
