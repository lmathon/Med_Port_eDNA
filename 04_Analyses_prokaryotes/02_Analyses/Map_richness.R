...
## Load data
data <- read.csv("04_Analyses_prokaryotes/00_data/prokaryote_presence.csv")
...
ggplot() +
  ...
  #         st.dist = 0.05) +
  labs(title = "Prokaryote taxa richness") +
...
### Save the map
image_write(final, "04_Analyses_prokaryotes/03_Outputs/Map_Richesse.png", density=300)
